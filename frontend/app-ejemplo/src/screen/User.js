...
const User = () => {
    ...
    const axiosData = async () => {
        try {
            const response = await axios.get('http://192.168.1.12:9004/nombres');
    ...
    const deleteUser = async (item) => {
        try {
            const response = await axios.delete(`http://192.168.1.12:9004/nombres/${item.id}`);
    ...
    const editUser = async () => {
        try {
            const response = await axios.put(`http://192.168.1.12:9004/nombres/${selectedUser.id}`, {
    ...
    const createUser = async () => {
        try {
            const response = await axios.post('http://192.168.1.12:9004/nombres', {
                firstName,
                lastName
            }, {
                headers: {
